      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Revolutionizing knee osteoarthritis diagnosis through advanced AI
            technology and collaborative medical expertise.
          </p>
        </motion.div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Our advanced machine learning algorithms provide accurate
                    and rapid analysis of knee X-rays, helping doctors make
            ...
            <CardContent className="p-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Get instant results with our real-time processing
                    capabilities, complete with detailed analysis and
                    recommendations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    measures, ensuring patient privacy and confidentiality.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Join a growing community of medical professionals
                    contributing to and benefiting from our collaborative
                    platform.
                  </p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <p className="text-4xl font-bold text-blue-600">9,000+</p>
